...
if (viewport <= 767) {
  ...
  footerNavTitle.forEach(function (ss) {
    var current = ss.parentElement.getElementsByClassName('footer__nav-list')[0];
    ss.addEventListener('click', function () {
      ss.parentElement.getElementsByClassName('footer__nav-list')[0].classList.toggle('footer__nav-list--hidden');
...
var addText = function addText() {
  ...
  var aboutText = document.getElementsByClassName('about__text');
  var arrayAboutText = Array.from(aboutText);
  var arrayAboutTextEnd = arrayAboutText.slice(2);
