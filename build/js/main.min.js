...
if (viewport <= 767) {
  ...
  footerNavTitle.forEach(function (titleElement) {
    var current = titleElement.parentElement.querySelectorAll('.footer__nav-list')[0];
    var currentElement = titleElement.parentElement.querySelectorAll('.footer__nav-element')[0];
    titleElement.addEventListener('click', function () {
      ...
      footerListNav.forEach(function (listElement) {
...
var addText = function addText() {
  ...
  arrayAboutTextEnd.forEach(function (element) {
    element.classList.toggle('about__text--hidden');
  });
  if (button) {
    button.addEventListener('click', function () {
      arrayAboutTextEnd.forEach(function (buttonElement) {
...
var addScroll = function addScroll() {
  ...
  var isScroll = function isScroll(evt) {
    evt.preventDefault();
    form.scrollIntoView({
      block: 'start',
      behavior: 'smooth'
...
document.querySelectorAll('.form form').forEach(function (item) {
  item.addEventListener('submit', function (evt) {
    var phoneInput = item.querySelector('input[name="tel"]');
