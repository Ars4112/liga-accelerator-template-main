...
var footerListNav = document.querySelectorAll('.footer__nav-list');
var footerNavTitle = document.querySelectorAll('.footer__nav-title');
var footerNavElement = document.querySelectorAll('.footer__nav-element');
var viewport = document.documentElement.clientWidth;
if (viewport <= 767) {
  footerNavElement.forEach(function (element) {
  ...
  footerNavTitle.forEach(function (ss) {
    var current = ss.parentElement.querySelectorAll('.footer__nav-list')[0];
    var ff = ss.parentElement.querySelectorAll('.footer__nav-element')[0];
    ss.addEventListener('click', function () {
      current.classList.toggle('footer__nav-list--hidden');

      // ff.classList.toggle('footer__nav-element--opened');

      var isClosed = current.classList.contains('footer__nav-list--hidden');
      if (!isClosed) {
        ff.classList.add('footer__nav-element--closed');
      } else {
        ff.classList.remove('footer__nav-element--closed');
      }
      if (isClosed) {
        return;
      }
      footerListNav.forEach(function (zz) {
        if (zz !== current) {
          zz.classList.add('footer__nav-list--hidden');
          zz.parentElement.querySelectorAll('.footer__nav-element')[0].classList.remove('footer__nav-element--closed');
        }
      });
    });
  });
...
var addText = function addText() {
  ...
  var aboutText = document.querySelectorAll('.about__text-module');
  var arrayAboutText = Array.from(aboutText);
  var arrayAboutTextEnd = arrayAboutText.slice(3);
  if (viewport <= 767) {
    arrayAboutTextEnd = arrayAboutText.slice(2);
  }
  arrayAboutTextEnd.forEach(function (ss) {
...
var addScroll = function addScroll() {
  var mainPageButton = document.querySelector('.main-page__button');
  ...
  mainPageButton.addEventListener('keydown', function (evt) {
    if (evt.key === 'Enter') {
      isScroll();
    }
  });
